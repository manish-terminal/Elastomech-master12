...
const Sidebar2 = ({ role }) => {
  ...
  const links = role === "admin"
    ? [
        ...
        { name: "Inventory", Icon: MdOutlineInventory, path: "/admin/inventory" },
    ...
    : [
        { name: "Dashboard", Icon: MdDashboard, path: "/worker" },
        { name: "Inventory", Icon: MdOutlineInventory, path: "/worker/inventory" },
        { name: "Orders", Icon: FaBoxOpen, path: "/worker/orders" },
        { name: "Add Order", Icon: CiBoxList, path: "/worker/add-order" },
        { name: "Formula Bin", Icon: SlChemistry, path: "/worker/formula-bin" },
      ];
        ...
        <div className="flex items-center gap-2">
          ...
          {open && (
            ...
            >
              ...
              <span className="block text-xs text-slate-500">Your Plan</span>
            </motion.div>
          )}
        </div>
